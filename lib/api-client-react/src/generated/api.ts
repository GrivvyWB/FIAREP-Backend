...
export const getListNychaDevelopmentsUrl = () => {




  return `/api/v1/nycha/developments`
}

/**
 * @summary List the official ordered NYCHA development catalog
 */
export const listNychaDevelopments = async ( options?: Parameters<typeof customFetch>[1]): Promise<NychaDevelopment[]> => {

  return customFetch<NychaDevelopment[]>(getListNychaDevelopmentsUrl(),
  {
    ...options,
    method: 'GET'
...
export const getListNychaDevelopmentsQueryKey = () => {
    return [
    `/api/v1/nycha/developments`
    ] as const;
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getListNychaDevelopmentsQueryKey();



    const queryFn: QueryFunction<Awaited<ReturnType<typeof listNychaDevelopments>>> = ({ signal }) => listNychaDevelopments({ signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof listNychaDevelopments>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useListNychaDevelopments<TData = Awaited<ReturnType<typeof listNychaDevelopments>>, TError = ErrorType<unknown>>(
  ...
  const queryOptions = getListNychaDevelopmentsQueryOptions(options)
...
export const getSearchNychaAddressesUrl = (params?: SearchNychaAddressesParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/api/v1/nycha/addresses?${stringifiedParams}` : `/api/v1/nycha/addresses`
}

/**
 * @summary Search official NYCHA addresses
 */
export const searchNychaAddresses = async (params?: SearchNychaAddressesParams, options?: Parameters<typeof customFetch>[1]): Promise<NychaAddress[]> => {

  return customFetch<NychaAddress[]>(getSearchNychaAddressesUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getSearchNychaAddressesQueryKey = (params?: SearchNychaAddressesParams,) => {
    return [
    `/api/v1/nycha/addresses`, ...(params ? [params] : [])
    ] as const;
    }
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getSearchNychaAddressesQueryKey(params);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof searchNychaAddresses>>> = ({ signal }) => searchNychaAddresses(params, { signal, ...requestOptions });





   return  { queryKey, queryFn, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof searchNychaAddresses>>, TError, TData> & { queryKey: QueryKey }
}
...
export function useSearchNychaAddresses<TData = Awaited<ReturnType<typeof searchNychaAddresses>>, TError = ErrorType<Error>>(
 params?: SearchNychaAddressesParams, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof searchNychaAddresses>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
  ...
  const queryOptions = getSearchNychaAddressesQueryOptions(params,options)
...
export const getUpdateStaffDevelopmentsUrl = (id: string,) => {




  return `/api/v1/staff/${id}/developments`
}

export const updateStaffDevelopments = async (id: string,
    staffDevelopmentUpdate: StaffDevelopmentUpdate, options?: Parameters<typeof customFetch>[1]): Promise<Staff> => {

  return customFetch<Staff>(getUpdateStaffDevelopmentsUrl(id),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(staffDevelopmentUpdate)
  }
);}
...
export const getUpdateStaffDevelopmentsMutationOptions = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateStaffDevelopments>>, TError,{id: string;data: BodyType<StaffDevelopmentUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateStaffDevelopments>>, TError,{id: string;data: BodyType<StaffDevelopmentUpdate>}, TContext> => {

const mutationKey = ['updateStaffDevelopments'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateStaffDevelopments>>, {id: string;data: BodyType<StaffDevelopmentUpdate>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateStaffDevelopments(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateStaffDevelopmentsMutationResult = NonNullable<Awaited<ReturnType<typeof updateStaffDevelopments>>>
    export type UpdateStaffDevelopmentsMutationBody = BodyType<StaffDevelopmentUpdate>
    export type UpdateStaffDevelopmentsMutationError = ErrorType<Error>

    export const useUpdateStaffDevelopments = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateStaffDevelopments>>, TError,{id: string;data: BodyType<StaffDevelopmentUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateStaffDevelopments>>,
        TError,
        {id: string;data: BodyType<StaffDevelopmentUpdate>},
        TContext
      > => {
      return useMutation(getUpdateStaffDevelopmentsMutationOptions(options));
    }

export const getUpdateStaffAssignmentUrl = (id: string,) => {




  return `/api/v1/staff/${id}/assignment`
}

export const updateStaffAssignment = async (id: string,
    staffAssignmentUpdate: StaffAssignmentUpdate, options?: Parameters<typeof customFetch>[1]): Promise<Staff> => {

  return customFetch<Staff>(getUpdateStaffAssignmentUrl(id),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(staffAssignmentUpdate)
  }
);}
...
export const getUpdateStaffAssignmentMutationOptions = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateStaffAssignment>>, TError,{id: string;data: BodyType<StaffAssignmentUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateStaffAssignment>>, TError,{id: string;data: BodyType<StaffAssignmentUpdate>}, TContext> => {

const mutationKey = ['updateStaffAssignment'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateStaffAssignment>>, {id: string;data: BodyType<StaffAssignmentUpdate>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateStaffAssignment(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateStaffAssignmentMutationResult = NonNullable<Awaited<ReturnType<typeof updateStaffAssignment>>>
    export type UpdateStaffAssignmentMutationBody = BodyType<StaffAssignmentUpdate>
    export type UpdateStaffAssignmentMutationError = ErrorType<Error>

    export const useUpdateStaffAssignment = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateStaffAssignment>>, TError,{id: string;data: BodyType<StaffAssignmentUpdate>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateStaffAssignment>>,
        TError,
        {id: string;data: BodyType<StaffAssignmentUpdate>},
        TContext
      > => {
      return useMutation(getUpdateStaffAssignmentMutationOptions(options));
    }
...
export const getCompleteHrEmployeeIntakeUrl = (id: string,) => {
  ...
  return `/api/v1/hr/employee-records/${id}/complete`
}
...
export const completeHrEmployeeIntake = async (id: string,
  ...
  return customFetch<HREmployeeCode>(getCompleteHrEmployeeIntakeUrl(id),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(completeHrEmployeeIntakeBody)
  }
);}
...
export const getSendHrStaffCodeUrl = (id: string,) => {




  return `/api/v1/hr/staff/${id}/send-code`
}

/**
 * @summary Email a still-visible employee sign-in code
 */
export const sendHrStaffCode = async (id: string, options?: Parameters<typeof customFetch>[1]): Promise<void> => {

  return customFetch<void>(getSendHrStaffCodeUrl(id),
  {
    ...options,
    method: 'POST'
...
export const getSendHrStaffCodeMutationOptions = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendHrStaffCode>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof sendHrStaffCode>>, TError,{id: string}, TContext> => {

const mutationKey = ['sendHrStaffCode'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof sendHrStaffCode>>, {id: string}> = (props) => {
          const {id} = props ?? {};

          return  sendHrStaffCode(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type SendHrStaffCodeMutationResult = NonNullable<Awaited<ReturnType<typeof sendHrStaffCode>>>

    export type SendHrStaffCodeMutationError = ErrorType<Error>

    /**
 * @summary Email a still-visible employee sign-in code
 */
export const useSendHrStaffCode = <TError = ErrorType<Error>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof sendHrStaffCode>>, TError,{id: string}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof sendHrStaffCode>>,
        TError,
        {id: string},
        TContext
      > => {
      return useMutation(getSendHrStaffCodeMutationOptions(options));
    }
