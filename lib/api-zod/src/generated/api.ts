...
export const LoginResponse = zod.object({
  ...
  "position": zod.enum(['Borough Director', 'Regional Director', 'Assistant Regional Director', 'Property Manager', 'Assistant Property Manager', 'Superintendent', 'Superintendent Ⓔ', 'Assistant Superintendent', 'Housing Assistant', 'Director', 'Supervisor Inspector', 'CPM Supervisor', 'Plumbing Supervisor', 'Plumber Supervisor', 'Electrical Supervisor', 'Electric Supervisor', 'Elevator Supervisor', 'Painter Supervisor', 'Carpenter Supervisor', 'Heating Service Supervisor', 'Bricklayer Supervisor', 'Maintenance Supervisor', 'Grounds Supervisor', 'Inspector', 'CPM', 'Plumber', 'Electrician', 'Elevator Service', 'Painter', 'Carpenter', 'Heating Service', 'Bricklayer', 'Roofer', 'General Construction', 'CCTV Installation', 'Maintenance Worker', 'Caretaker', 'Porter', 'Laborer', 'Groundskeeper', 'Staff Worker', 'Administrative Staff', 'Other Support Staff', 'Human Resources', 'Procurement', 'Janitorial Staff', 'Other']),
  "status": zod.string(),
...
export const UpdateStaffAssignmentParams = zod.object({
  "id": zod.coerce.string()
})
...
export const GetHrWorkspaceResponse = zod.object({
