  ...
  return (
    <div className="grid-bg relative w-screen h-screen overflow-hidden font-body text-text">
      ...
      <div className="absolute left-[8vw] top-[12vh] w-[84vw]">
        <h2 className="max-w-[80vw] text-[4.1vw] font-bold leading-[1.08] tracking-[-0.035em] text-[#111111]">Built, verified, and ready to publish</h2>
        <div className="mt-[3.5vh] grid grid-cols-[1.2fr_0.8fr] gap-[3vw]">
          ...
          <div className="flex flex-col justify-between border border-primary bg-primary p-[2.6vw] text-white">
            <div>
              <div className="text-[1.5vw] font-bold uppercase tracking-[0.14em] text-[#DCE8F2]">Launch status</div>
              <div className="mt-[3vh] text-[5.4vw] font-bold leading-none tracking-[-0.05em]">Ready</div>
            </div>
            <p className="text-[1.85vw] font-medium leading-[1.42] text-white">Next step: publish FIAREP and complete a short production smoke check</p>
          </div>
        </div>
      </div>
    </div>
