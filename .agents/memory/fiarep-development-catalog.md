...
**Why:** Discovering developments from existing assignments creates a circular dependency: a new employee cannot be assigned until a development already appears on another record.

**How to apply:** Save organization type and development names with the organization, show the resulting portfolio size in Platform Control, expose only those names to tenant staff, and require non-Borough-Director staff accounts to receive at least one approved development assignment.