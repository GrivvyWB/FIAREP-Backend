...
Staff access codes are numeric four-digit credentials generated only by the server and shown once to the authorized issuer. Organizations and staff must never choose their own codes, and idempotent retries must never reveal an existing code.
