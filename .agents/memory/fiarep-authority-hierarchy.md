...
Human Resources is a dedicated staff role and the organization-wide staffing authority. HR can use the ordered employee-creation flow and development catalog without inheriting Administrator operational access. Borough Directors and Administrators may create the first HR account; HR cannot create Administrators, Borough Directors, or other HR accounts.
