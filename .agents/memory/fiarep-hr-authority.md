...
**How to apply:** Give HR full visibility and administrative workflow access for employee matters. Add explicit confirmation and approval boundaries to high-impact actions, preserve audit records, and enforce immediate-supervisor scope and leave privacy on the server rather than only hiding controls in the interface.