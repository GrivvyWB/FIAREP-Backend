...
License date-time fields must display saved timestamps in the browser’s local time before a `datetime-local` edit. Formatting them directly from UTC and parsing them again as local time shifts every save by the timezone offset.
