...
Every resident complaint must alert both its development-scoped management recipients and every approved Superintendent Ⓔ in the tenant. Superintendent Ⓔ receives complaints at all hours, even when assigned to a different development, because the emergency supervisor provides 24/7 coverage and takes over after development supervisors leave at 4 PM.
